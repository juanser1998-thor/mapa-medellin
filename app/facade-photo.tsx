...
export function FacadePhoto({
  ...
  return (
    <Dialog>
      <DialogTrigger className={`group relative block w-full overflow-hidden rounded-2xl border border-white/90 bg-[#e8efed] text-left shadow-[0_16px_44px_rgba(24,52,47,.18)] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#168a77] ${className}`} aria-label={`Ampliar fachada de un inmueble en ${barrio}`}>
      ...
      <DialogContent className="w-[96vw] border-white/80 bg-white p-4 text-[#102723] sm:max-w-6xl sm:p-6">
