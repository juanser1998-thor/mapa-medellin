    ...
    for (let t in u) {
      ...
      for (let e of u[t]) {
        ...
        (t.source !== this.source &&
          m(
            `layer.source = ${t.source} does not equal this.source = ${this.source}`,
          ),
...
function ce(e, t, n) {
  ...
  for (let t = 0; t < e.length; t++) {
    let n = e.feature(t),
      c = n.loadGeometry();
    for (let e of c)
      for (let t of e) ((t.x = t.x * i - a), (t.y = t.y * i - o));
    ...
    async loadTile(e) {
      ...
      try {
        ...
        if (e.etag && e.etag === s.etag)
          return (
            this.tileState.finishLoading(t), this._getEtagUnmodifiedResult(s, r)
          );
    ...
    _filterGeoJSON(e, t, n) {
      ...
      return r
        ? {
            ...
            features: e.features.filter((e) => r(e)),
          }
        : e;
    }
